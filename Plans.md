...
| R.3.4 | [review-gate] Phase R.3 review gate | 检视记录；DB 新记录存储 i18n key；迁移脚本幂等；_STRATEGY_NAME_MAP 已删；pytest tests/unit/ -m "not slow" 全绿；**R.3.2 迁移脚本必须在 R.3.3 部署前执行**（R.3.1 Skeptic M4 落实：避免 R.3.3 删除 _STRATEGY_NAME_MAP 后历史数据无法翻译） | R.3.1-R.3.3 | cc:TODO |
