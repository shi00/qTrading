...
TABLE_DEFINITIONS = {
    ...
    "sw_industry_member": {
        ...
        "desc": "申万行业成分股映射（Phase 3F-1，全局快照，对应 Tushare index_member_all 接口）",
        "sync_config": {
            "strategy": "sw_industry",
            "api": "get_index_member_all",
            "keys": ["ts_code", "index_code"],
        },
        "quality_config": {"tier": 1, "monitor": True, "sparse": False},
        "columns": {
            "ts_code": "col_ts_code",
            "index_code": "col_index_code",
            "index_name": "col_index_name",
            "sw_l1_code": "col_sw_l1_code",
            "sw_l1_name": "col_sw_l1_name",
            "sw_l2_code": "col_sw_l2_code",
            "sw_l2_name": "col_sw_l2_name",
            "sw_l3_code": "col_sw_l3_code",
            "sw_l3_name": "col_sw_l3_name",
        },
    },
    "repurchase": {
