...
class FinancialDao(BaseDao):
    async def save_financial_reports(self, df: pd.DataFrame):
        ...
        # NOTE: COALESCE semantics - preserves existing values when new value is NULL.
        # This means if a company corrects a report field to NULL/0, the old value will be kept.
        # This is intentional to prevent accidental data loss from incomplete API responses.
        # If explicit NULL updates are needed, a separate update method should be used.
        sql = """
            INSERT INTO financial_reports (
                ...
                "netprofit_margin","debt_to_assets","or_yoy","netprofit_yoy","goodwill","audit_result"
            ) VALUES (
