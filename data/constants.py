...
WATERMARK_KEY_PREFIXES: tuple[str, ...] = ("sync_attempted_upto", "sched_last_")
...
# 真相源位于 utils.constants（§4.1：utils 为横切关注点，data 可引用 utils）。
from utils.constants import TUSHARE_POINT_TIERS as TUSHARE_POINT_TIERS
