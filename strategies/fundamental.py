...
class ValueStrategy(PolarsBaseStrategy):
    ...
    def get_parameters(self):
        return [
            {"name": "pe_min", "label_key": "param_pe_min", "type": "slider",
             "min": 0, "max": 50, "default": 5, "step": 1},
            {"name": "pe_max", "label_key": "param_pe_max", "type": "slider",
             "min": 5, "max": 100, "default": 20, "step": 1},
            {"name": "pb_max", "label_key": "param_pb_max", "type": "slider",
             "min": 0.5, "max": 10, "default": 3, "step": 0.5},
            {"name": "dv_min", "label_key": "param_dv_min", "type": "slider",
    ...
    def _filter_logic(self, lf: pl.LazyFrame, context: dict) -> pl.LazyFrame:
        ...
        return (
            lf
            .drop_nulls(subset=['pe_ttm', 'pb', 'dv_ttm'])
...
class GrowthStrategy(PolarsBaseStrategy):
    ...
    def get_parameters(self):
        return [
            {"name": "revenue_growth_min", "label_key": "param_revenue_growth", "type": "slider",
             "min": 0, "max": 100, "default": 20, "step": 5},
            {"name": "profit_growth_min", "label_key": "param_profit_growth", "type": "slider",
             "min": 0, "max": 200, "default": 25, "step": 5},
            {"name": "roe_min", "label_key": "param_roe_min", "type": "slider",
             "min": 0, "max": 50, "default": 15, "step": 1},
        ]
    ...
    def _filter_logic(self, lf: pl.LazyFrame, context: dict) -> pl.LazyFrame:
        ...
        return (
            lf
            .drop_nulls(subset=['or_yoy', 'netprofit_yoy', 'roe'])
...
class DividendStrategy(PolarsBaseStrategy):
    ...
    def get_parameters(self):
        return [
            {"name": "dv_min", "label_key": "param_dv_min", "type": "slider",
             "min": 1, "max": 15, "default": 4, "step": 0.5},
        ]
...
class CashFlowStrategy(PolarsBaseStrategy):
    ...
    def get_parameters(self):
        return [
            {"name": "debt_max", "label_key": "param_debt_max", "type": "slider",
             "min": 10, "max": 90, "default": 50, "step": 5},
            {"name": "roe_min", "label_key": "param_roe_min", "type": "slider",
    ...
    def _filter_logic(self, lf: pl.LazyFrame, context: dict) -> pl.LazyFrame:
        ...
        return (
            lf
            .drop_nulls(subset=['debt_to_assets', 'roe'])
...
class LargePEStrategy(PolarsBaseStrategy):
    ...
    def get_parameters(self):
        return [
            {"name": "market_cap_min", "label_key": "param_market_cap", "type": "slider",
             "min": 50, "max": 5000, "default": 500, "step": 50},
            {"name": "pe_max", "label_key": "param_pe_max", "type": "slider",
    ...
    def _filter_logic(self, lf: pl.LazyFrame, context: dict) -> pl.LazyFrame:
        ...
        return (
            lf
            .drop_nulls(subset=['total_mv', 'pe_ttm'])
