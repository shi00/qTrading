...
class TestValueStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_df = pd.DataFrame([
            {"ts_code": "000001.SZ", "name": "平安银行", "pe_ttm": 6.5, "pb": 0.8, "dv_ttm": 3.5},
            {"ts_code": "000002.SZ", "name": "万科A", "pe_ttm": 8.0, "pb": 1.2, "dv_ttm": 2.8},
            {"ts_code": "000003.SZ", "name": "测试股票", "pe_ttm": 25.0, "pb": 2.5, "dv_ttm": 1.0},
            {"ts_code": "000004.SZ", "name": "高PE股", "pe_ttm": 50.0, "pb": 4.0, "dv_ttm": 0.5},
            {"ts_code": "000005.SZ", "name": "亏损股", "pe_ttm": -5.0, "pb": 0.5, "dv_ttm": 0.0},
        ])
...
class TestGrowthStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_df = pd.DataFrame([
            {"ts_code": "000001.SZ", "name": "高成长", "or_yoy": 30.0, "netprofit_yoy": 40.0, "roe": 20.0},
            {"ts_code": "000002.SZ", "name": "中成长", "or_yoy": 25.0, "netprofit_yoy": 30.0, "roe": 18.0},
            {"ts_code": "000003.SZ", "name": "低成长", "or_yoy": 15.0, "netprofit_yoy": 20.0, "roe": 10.0},
            {"ts_code": "000004.SZ", "name": "负增长", "or_yoy": -5.0, "netprofit_yoy": -10.0, "roe": 5.0},
        ])
...
class TestCashFlowStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_df = pd.DataFrame([
            {"ts_code": "000001.SZ", "name": "低负债高ROE", "debt_to_assets": 30.0, "roe": 15.0},
            {"ts_code": "000002.SZ", "name": "中负债中ROE", "debt_to_assets": 45.0, "roe": 12.0},
            {"ts_code": "000003.SZ", "name": "高负债低ROE", "debt_to_assets": 70.0, "roe": 5.0},
            {"ts_code": "000004.SZ", "name": "低负债低ROE", "debt_to_assets": 20.0, "roe": 8.0},
        ])
...
class TestLargePEStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_df = pd.DataFrame([
            {"ts_code": "000001.SZ", "name": "大盘低PE", "total_mv": 10000000, "pe_ttm": 10.0},
            {"ts_code": "000002.SZ", "name": "中盘中PE", "total_mv": 3000000, "pe_ttm": 15.0},
            {"ts_code": "000003.SZ", "name": "小盘高PE", "total_mv": 500000, "pe_ttm": 25.0},
            {"ts_code": "000004.SZ", "name": "大盘高PE", "total_mv": 8000000, "pe_ttm": 30.0},
        ])
