...
class TestTechnicalBreakoutStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_df = pd.DataFrame([
            {"ts_code": "000001.SZ", "name": "突破股A", "pct_chg": 5.0, "turnover_rate": 8.0},
            {"ts_code": "000002.SZ", "name": "突破股B", "pct_chg": 3.5, "turnover_rate": 5.0},
            {"ts_code": "000003.SZ", "name": "涨幅过大", "pct_chg": 9.5, "turnover_rate": 12.0},
            {"ts_code": "000004.SZ", "name": "涨幅过小", "pct_chg": 1.0, "turnover_rate": 4.0},
            {"ts_code": "000005.SZ", "name": "换手率低", "pct_chg": 4.0, "turnover_rate": 1.0},
        ])
...
class TestNorthboundStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.base_df = pd.DataFrame([
            {"ts_code": "000001.SZ", "name": "平安银行", "industry": "银行", "pe_ttm": 6.5, "total_mv": 1000000},
            {"ts_code": "000002.SZ", "name": "万科A", "industry": "房地产", "pe_ttm": 8.0, "total_mv": 800000},
            {"ts_code": "600000.SH", "name": "浦发银行", "industry": "银行", "pe_ttm": 5.0, "total_mv": 1200000},
        ])
...
class TestInstitutionalStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.base_df = pd.DataFrame([
            {"ts_code": "000001.SZ", "name": "机构买入股", "industry": "银行", "pe_ttm": 6.5, "total_mv": 1000000},
            {"ts_code": "000002.SZ", "name": "普通股", "industry": "房地产", "pe_ttm": 8.0, "total_mv": 800000},
        ])
...
class TestBlockTradeStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.base_df = pd.DataFrame([
            {"ts_code": "000001.SZ", "name": "大宗交易股", "industry": "银行", "pe_ttm": 6.5, "total_mv": 1000000},
            {"ts_code": "000002.SZ", "name": "普通股", "industry": "房地产", "pe_ttm": 8.0, "total_mv": 800000},
        ])
