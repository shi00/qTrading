...
class TestLogger(unittest.TestCase):
    ...
    def test_setup_logging_defaults(self):
        ...
        with patch('utils.config_handler.ConfigHandler.get_log_max_mb', return_value=5), \
            ...
            file_handler = [h for h in logger.handlers if isinstance(h, logging.handlers.RotatingFileHandler) and 'app.log' in h.baseFilename][0]
    ...
    def test_setup_logging_custom_config(self):
        ...
        with patch('utils.config_handler.ConfigHandler.get_log_max_mb', return_value=1), \
             patch('utils.config_handler.ConfigHandler.get_log_backup_count', return_value=2):
