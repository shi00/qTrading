...
class I18n:
    ...
    STRINGS = {
        "zh": {
            ...
            "col_ann_date": "Announce Date",
            "col_end_date": "Report Date",
            "col_list_date": "List Date",
            "col_created_at": "Created At",
            "col_updated_at": "Updated At",
            "col_update_flag": "Update Flag",
            "col_publish_time": "Publish Time",
            "col_cal_date": "Calendar Date",
            "col_pretrade_date": "Previous Date",
            "col_suspend_timing": "Suspend Time",
            "col_exp_date": "Expire Date",
            "col_record_date": "Record Date",
            "col_ex_date": "Ex-Dividend Date",
            "col_open": "Open",
            "col_high": "High",
            "col_low": "Low",
            "col_close": "Close",
            "col_pre_close": "Prev Close",
            "col_change": "Change",
            "col_pct_chg": "Change%",
            "col_vol": "Volume",
            "col_volume": "Volume",
            ...
            "col_turnover_rate_f": "Turnover Free",
            "col_adj_factor": "Adj Factor",
            "col_qfq_open": "Adj Open",
            "col_qfq_high": "Adj High",
            "col_qfq_low": "Adj Low",
            "col_qfq_close": "Adj Close",
            "col_pe": "PE",
            "col_pe_ttm": "PE(TTM)",
            "col_pb": "PB",
            "col_ps": "PS",
            "col_ps_ttm": "PS(TTM)",
            "col_dv_ratio": "Dividend Yield",
            "col_dv_ttm": "Div Yield(TTM)",
            "col_total_mv": "Total Cap",
            "col_circ_mv": "Float Cap",
            "col_float_mv": "Float Cap",
            "col_float_values": "Float Cap",
            ...
            "col_n_income": "Net Income",
            "col_n_income_attr_p": "Net Income (Parent)",
            "col_total_assets": "Total Assets",
            "col_total_liab": "Total Liab",
            "col_total_hldr_eqy_exc_min_int": "Shareholder Equity",
            "col_roe": "ROE",
            "col_roe_dt": "ROE(Diluted)",
            "col_grossprofit_margin": "Gross Margin",
            "col_netprofit_margin": "Net Margin",
            "col_debt_to_assets": "Debt Ratio",
            "col_or_yoy": "Rev YoY",
            "col_netprofit_yoy": "Profit YoY",
            "col_goodwill": "Goodwill",
            "col_buy_sm_vol": "Small Buy Vol", "col_sell_sm_vol": "Small Sell Vol",
            "col_buy_sm_amount": "Small Buy Amt", "col_sell_sm_amount": "Small Sell Amt",
            "col_buy_md_vol": "Medium Buy Vol", "col_sell_md_vol": "Medium Sell Vol",
            "col_buy_md_amount": "Medium Buy Amt", "col_sell_md_amount": "Medium Sell Amt",
            "col_buy_lg_vol": "Large Buy Vol", "col_sell_lg_vol": "Large Sell Vol",
            "col_buy_lg_amount": "Large Buy Amt", "col_sell_lg_amount": "Large Sell Amt",
            "col_buy_elg_vol": "Huge Buy Vol", "col_sell_elg_vol": "Huge Sell Vol",
            "col_buy_elg_amount": "Huge Buy Amt", "col_sell_elg_amount": "Huge Sell Amt",
            "col_net_mf_amount": "Net Inflow Amt",
            "col_net_mf_vol": "Net Inflow Vol",
            "col_area": "Area",
            ...
            "col_type": "Type",
            "col_p_change_min": "Pct Chg Min",
            "col_p_change_max": "Pct Chg Max",
            "col_net_profit_min": "Net Profit Min",
            "col_net_profit_max": "Net Profit Max",
            "col_bz_item": "Business Item",
            "col_bz_sales": "Sales",
            "col_bz_profit": "Profit",
            "col_bz_cost": "Cost",
            "col_curr_type": "Currency",
            "col_div_proc": "Progress",
            "col_stk_div": "Stock Div",
            "col_stk_bo_rate": "Bonus Rate",
            "col_stk_co_rate": "Conversion Rate",
            "col_cash_div_tax": "Cash Div (Pre-tax)",
            "col_cash_div_tax_rate": "Tax Rate",
            "col_reason": "Reason",
            "col_l_sell": "Sell Amt",
            "col_l_buy": "Buy Amt",
            "col_l_amount": "Total Amt",
            "col_net_amount": "Net Amt",
            "col_net_rate": "Net Rate",
            "col_amount_rate": "Amount Rate",
            "col_price": "Price",
            "col_buyer": "Buyer Branch",
            "col_seller": "Seller Branch",
            "col_ratio": "Ratio",
            "col_rzye": "Margin Balance",
            "col_rqye": "Short Balance",
            "col_rzmre": "Margin Buy",
            "col_rqyl": "Short Volume",
            "col_rzrqye": "Total Balance",
            "col_pledge_count": "Pledge Count",
            "col_unrest_pledge": "Unrest Pledged",
            "col_rest_pledge": "Rest Pledged",
            "col_pledge_ratio": "Pledge Ratio",
            "col_proc": "Progress",
            "col_high_limit": "Limit Price",
            "col_low_limit": "Limit Floor",
            "col_amp": "Amplitude",
            "col_fc_ratio": "Cap Ratio",
            "col_fl_ratio": "Flow Ratio",
            "col_fd_amount": "Cap Amt",
            "col_first_time": "First Limit",
            "col_last_time": "Last Limit",
            "col_open_times": "Open Times",
            "col_strth": "Strength",
            "col_limit_type": "Limit Type",
            "col_suspend_type_name": "Suspend Reason",
            "col_ai_reason": "AI Reason",
            "col_strategy_name": "Strategy Name",
            "col_prediction_result": "Prediction",
            "col_t1_price": "T+1 Price",
            "col_t5_price": "T+5 Price",
            "col_t1_pct": "T+1 Pct",
            "col_t5_pct": "T+5 Pct",
            "col_table_name": "Table Name",
            "col_last_sync_date": "Last Sync",
            "col_last_data_date": "Last Data",
            "col_record_count": "Count",
            "col_step4_completed_at": "Completed At",
            ...
            "col_goodwill": "商誉",
            "col_buy_sm_vol": "小单买量", "col_sell_sm_vol": "小单卖量",
            "col_buy_sm_amount": "小单买额", "col_sell_sm_amount": "小单卖额",
            "col_buy_md_vol": "中单买量", "col_sell_md_vol": "中单卖量",
            "col_buy_md_amount": "中单买额", "col_sell_md_amount": "中单卖额",
            "col_buy_lg_vol": "大单买量", "col_sell_lg_vol": "大单卖量",
            "col_buy_lg_amount": "大单买额", "col_sell_lg_amount": "大单卖额",
            "col_buy_elg_vol": "特大单买量", "col_sell_elg_vol": "特大单卖量",
            "col_buy_elg_amount": "特大单买额", "col_sell_elg_amount": "特大单卖额",
