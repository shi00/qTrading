...
class ScreenerView(ft.Container):
                ...
                ft.Container(
                    content=ft.Column([
                        ft.Row([
                            ...
                            ft.IconButton(icon=ft.Icons.REFRESH, tooltip=I18n.get("screener_reload_data"), on_click=self.on_init_data),
                            self.progress_ring
        ...
        try:
            ...
            def on_stream_result(row_data):
                ...
                if thinking:
                    ...
                    self.log_view.controls.append(ft.Text(f"[{stock_name}] Finished analysis (Score: {score})", size=12, color=ft.Colors.GREY))
    ...
    def render_table(self):
        ...
        for _, row in page_data.iterrows():
            ...
            score_color = ft.Colors.GREEN if (ai_score or 0) >= 80 else (ft.Colors.ORANGE if (ai_score or 0) >= 60 else ft.Colors.GREY)
    ...
    def update_pagination_controls(self):
        ...
        self.page_info.value = I18n.get("screener_page_info").format(current=self.page_no, total=total_pages) + f" ({total_items})"
