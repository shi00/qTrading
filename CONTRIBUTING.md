...
>
> **对应版本**：0.9.0（产品版本，与 pyproject.toml 一致，与 [CLAUDE.md](./CLAUDE.md) 保持一致）
> **元数据**（P2-07 统一格式，与 CLAUDE.md 规则集版本一致）：
> - owner: 架构维护者
> - ruleset_version: 1.6.0（与 CLAUDE.md 同步，规则集版本变更时递增）
...
- [redlines.yml](./docs/governance/redlines.yml) — CLAUDE.md §3.1 红线表的机器可读镜像（R1~R22 编号/标题/说明/enforcement/human_review_required）
