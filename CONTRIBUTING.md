...
> - owner: 架构维护者
> - ruleset_version: 1.4.0（与 CLAUDE.md 同步，规则集版本变更时递增）
...
- [redlines.yml](./docs/governance/redlines.yml) — CLAUDE.md §3.1 红线表的机器可读镜像（R1~R19 编号/标题/说明/enforcement/human_review_required）
