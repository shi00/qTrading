...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_daily_indicators_trade_date'), 'daily_indicators', ['trade_date'], unique=False)
    ...
    op.create_index('ix_financial_reports_ts_code_ann_date', 'financial_reports', ['ts_code', 'ann_date'], unique=False)
    ...
    op.create_index(op.f('ix_moneyflow_daily_trade_date'), 'moneyflow_daily', ['trade_date'], unique=False)
