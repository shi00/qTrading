...
def upgrade() -> None:
    ...
    with op.batch_alter_table('adj_factor', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_adj_factor_trade_date'), ['trade_date'], unique=False)
    ...
    with op.batch_alter_table('daily_indicators', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_daily_indicators_trade_date'), ['trade_date'], unique=False)
    ...
    with op.batch_alter_table('dividend', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_dividend_ann_date'), ['ann_date'], unique=False)
    ...
    with op.batch_alter_table('fina_forecast', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_fina_forecast_ann_date'), ['ann_date'], unique=False)
    ...
    with op.batch_alter_table('fina_mainbz', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_fina_mainbz_end_date'), ['end_date'], unique=False)
    ...
    with op.batch_alter_table('financial_reports', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_financial_reports_end_date'), ['end_date'], unique=False)
    ...
    with op.batch_alter_table('index_daily', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_index_daily_trade_date'), ['trade_date'], unique=False)
    ...
    with op.batch_alter_table('index_weight', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_index_weight_trade_date'), ['trade_date'], unique=False)

    op.create_table('limit_list',
    sa.Column('trade_date', sa.String(), nullable=False),
    sa.Column('ts_code', sa.String(), nullable=False),
    ...
    with op.batch_alter_table('limit_list', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_limit_list_ts_code'), ['ts_code'], unique=False)

    op.create_table('macro_economy',
    ...
    with op.batch_alter_table('margin_daily', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_margin_daily_trade_date'), ['trade_date'], unique=False)
    ...
    with op.batch_alter_table('moneyflow_daily', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_moneyflow_daily_trade_date'), ['trade_date'], unique=False)

    op.create_table('moneyflow_hsgt',
    sa.Column('trade_date', sa.String(), nullable=False),
    ...
    with op.batch_alter_table('northbound_holding', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_northbound_holding_trade_date'), ['trade_date'], unique=False)
    ...
    with op.batch_alter_table('repurchase', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_repurchase_ann_date'), ['ann_date'], unique=False)
    ...
    with op.batch_alter_table('screening_history', schema=None) as batch_op:
        batch_op.create_index('idx_sh_date_strategy', ['trade_date', 'strategy_name'], unique=False)

    op.create_table('shibor_daily',
    ...
    with op.batch_alter_table('stk_holdernumber', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_stk_holdernumber_end_date'), ['end_date'], unique=False)
    ...
    with op.batch_alter_table('stock_basic', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_stock_basic_list_date'), ['list_date'], unique=False)
    ...
    with op.batch_alter_table('stock_concepts', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_stock_concepts_ts_code'), ['ts_code'], unique=False)
    ...
    with op.batch_alter_table('suspend_d', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_suspend_d_trade_date'), ['trade_date'], unique=False)
    ...
    with op.batch_alter_table('top10_holders', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_top10_holders_holder_name'), ['holder_name'], unique=False)
    ...
    with op.batch_alter_table('top_list', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_top_list_ts_code'), ['ts_code'], unique=False)
